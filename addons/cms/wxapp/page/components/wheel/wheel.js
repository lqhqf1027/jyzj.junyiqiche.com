...
class Wheel {
   ...
   */
    constructor (pageContext, opts) {
        ...
        this.prizeUrl = opts.prizeUrl
        this.btnUrl = opts.btnUrl
        this.hasMobile = opts.hasMobile
        ...
        this.page.start = (e) => {
            ...
            if (typeof opts.onStart === 'function') {
                opts.onStart.call(this, e)
            }
        }

        this.page.getPhoneNumber = (e) => {
            if (typeof opts.getPhoneNumber === 'function') {
                opts.getPhoneNumber.call(this, e)
            }
        }
    }

    init () {
        let { areaNumber, singleAngle, mode, prizeUrl, btnUrl, hasMobile } = this
