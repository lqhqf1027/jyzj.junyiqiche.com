        ...
        table: {
            ...
            new_customer: function () {
                ...
                newCustomer.bootstrapTable({
                    url: 'sales/Customerlisttabs/newCustomer',
                    extend: {
                        index_url: 'customer/customerresource/index',
                        add_url: 'sales/customerlisttabs/add',
                        edit_url: 'sales/customerlisttabs/edit',
                        del_url: 'customer/customerresource/del',
                        multi_url: 'customer/customerresource/multi',
                        give_up_url: 'sales/customerlisttabs/give_up',
...

                            {
                                ...
                                buttons: [
                                    ...
                                    },
                                    {
                                        ...
                                        url: 'sales/customerlisttabs/edit'
                ...
                batch_giveup(".btn-selected1", newCustomer, 'sales/Customerlisttabs/ajaxBatchGiveup');
                ...
                //     var url = 'sales/customerlisttabs/batchfeedback?ids=' + ids;
                //     var options = {
                //         shadeClose: false,
                //         shade: [0.3, '#393D49'],
                //         area: ['50%', '50%'],
            ...
            relation: function () {
                ...
                relations.bootstrapTable({
                    url: 'sales/Customerlisttabs/relation',
                    extend: {
                        index_url: 'customer/customerresource/index',
                        add_url: 'sales/customerlisttabs/add',
                        edit_url: 'sales/customerlisttabs/edit',
                                ...
                                }},
                            {
                                ...
                                buttons: [
                                    ...
                                    },
                                    {
                                        ...
                                        url: "sales/customerlisttabs/showFeedback"
                 ...
                 * 批量放弃
                 */
                batch_giveup(".btn-selected2", relations, 'sales/Customerlisttabs/ajaxBatchGiveup');
            ...
            intention: function () {
                ...
                intentions.bootstrapTable({
                    url: 'sales/Customerlisttabs/intention',
                    extend: {
                        index_url: 'customer/customerresource/index',
                        add_url: 'sales/customerlisttabs/add',
                 ...
                 * 批量放弃
                 */
                batch_giveup(".btn-selected3", intentions, 'sales/Customerlisttabs/ajaxBatchGiveup');
            ...
            nointention: function () {
                ...
                nointentions.bootstrapTable({
                    url: 'sales/Customerlisttabs/nointention',
                    extend: {
                        index_url: 'customer/customerresource/index',
                        add_url: 'sales/customerlisttabs/add',
                        edit_url: 'sales/customerlisttabs/edit',
                 ...
                 *
                 */
                batch_giveup(".btn-selected4", nointentions, 'sales/Customerlisttabs/ajaxBatchGiveup');
            ...
            giveup: function () {
                ...
                giveups.bootstrapTable({
                    url: 'sales/Customerlisttabs/giveup',
                    extend: {
                        index_url: 'customer/customerresource/index',
                        add_url: 'sales/customerlisttabs/add',
                        edit_url: 'sales/customerlisttabs/edit',
            ...
            overdue: function () {
                ...
                overdues.bootstrapTable({
                    url: 'sales/Customerlisttabs/overdue',
                    extend: {
                        index_url: 'customer/customerresource/index',
                        add_url: 'sales/customerlisttabs/add',
                        edit_url: 'sales/customerlisttabs/edit',
                 ...
                 * 批量放弃
                 */
                batch_giveup(".btn-selected5", overdues, 'sales/Customerlisttabs/ajaxBatchGiveup');
            ...
            events: {
                operate: {
                    ...
                    'click .btn-editone': function (e, value, row, index) {  //编辑
                        ...
                        var url = 'sales/customerlisttabs/edit';
                    ...
                    'click .btn-showFeedback': function (e, value, row, index) {
                        ...
                        var ids = row[options.pk];
                        row = $.extend({}, row ? row : {}, {ids: ids});
                        var url = "sales/customerlisttabs/showFeedback";
                        ...
                        Layer.confirm(
                            ...
                            function (index) {
                                ...
                                Layer.prompt(
                                    ...
                                    function (text, index) {
                                        Fast.api.ajax({
                                            url:"sales/Customerlisttabs/ajaxGiveup",
                                            data:{
                                                text:text,
                                                id:row[options.pk]
                                            }
