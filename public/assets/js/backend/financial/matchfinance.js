        ...
        table: {
            ...
            newprepare_match: function () {
                ...
                newprepareMatch.bootstrapTable({
                    url: "financial/matchfinance/newprepare_match",
                    extend: {
                        newedit_url: 'financial/matchfinance/newedit',
                        table: 'sales_order',
                    },
                    toolbar: '#toolbar1',
                    pk: 'id',
            ...
            secondprepare_match: function () {
                ...
                secondprepareMatch.bootstrapTable({
                    url: "financial/matchfinance/secondprepare_match",
                    extend: {
                        secondedit_url: 'financial/matchfinance/secondedit',
                        table: 'sales_order',
                    },
                    toolbar: '#toolbar2',
                    pk: 'id',
            ...
            events: {
                operate: {
                    ...
                    'click .btn-view-plan': function (e, value, row, index) {
                        ...
                        var ids = row[options.pk];
                        row = $.extend({}, row ? row : {}, {ids: ids});
                        var url = 'financial/matchfinance/view_plan';
                    ...
                    'click .btn-sales_editone': function (e, value, row, index) {
                        ...
                        Layer.confirm(
                            ...
                            function (index) {
                                ...
                                Fast.api.ajax({
                                    url:'financial/matchfinance/del_sales_order',
                                    data:{
                                        id:row[options.pk]
                                    }
                                },function (data,ret) {
                    ...
                    'click .btn-second_sales_editone': function (e, value, row, index) {
                        ...
                        Layer.confirm(
                            ...
                            function (index) {
                                ...
                                Fast.api.ajax({
                                    url:'financial/matchfinance/del_second_sales_order',
                                    data:{
                                        id:row[options.pk]
                                    }
                                },function (data,ret) {
