                ...
                table.bootstrapTable({
                    ...
                    columns: [
                        [
                            ...
                            {
                                field: 'orderdetails.is_it_illegal',
                                title: __('违章状态'),
                ...
                formatter: {
                    datetime: function (value, row, index) {
                        ...
                        if (isNaN(value)) {
                            ...
                            // console.log(Controller.api.getLocalTime(value));

                            return Moment(parseInt(value) * 1000).format(datetimeFormat) + ' ' + "<span class='label label-" + sign + "' style='cursor: pointer'>" + content + "</span>";
                        }
                    },
                    /**
                     * 0分标记
