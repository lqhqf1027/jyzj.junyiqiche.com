...
namespace app\admin\controller\wenjiang;
...
class Salesorder extends Backend
{
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax())
        {
            ...
            foreach ($list as $row) {
                $row->visible(['id','data1','data2','data3','data4','data5','data6','data7','data8','data9','data10','data11','data12','data13','data28','data29','salestype']);
