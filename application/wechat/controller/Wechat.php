...
class Wechat extends Controller
{
    ...
    public function adduser()
    {
        ...
        if (empty($user_data)) {
            ...
            if (!$r['subscribe']) {
                $this->alert('请先关注公众号，点击logo头像即可关注！', 'jump', 'https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=MzIyODAyNjE3NA==&scene=126&bizpsid=0&subscene=0#wechat_redirect');
